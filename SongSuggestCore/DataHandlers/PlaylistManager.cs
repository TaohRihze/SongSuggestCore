    ...
    public partial class PlaylistManager
    {
        ...
        private List<SongJson> GetSongJsons()
        {
            ...
            foreach (var songID in songIDs)
            {
                ...
                songJSON.hash = song.hash.ToLower();// songSuggest.songLibrary.GetHash(songID);
